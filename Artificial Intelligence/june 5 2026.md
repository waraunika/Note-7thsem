...
for each size we calculate distances as:

d0 = abs(1400 - 1000) = 400

d1 = abs(1400 - 1200) = 200

d2 = abs(1400 - 1500) = 100

d3 = abs(1400 - 1800) = 300

sorted distances: 100, 200, 300, 400

neighbors = k nearest neighbors = (100, 200)

prediction = sum of distances of k neighbors / k
