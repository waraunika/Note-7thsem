...
| -------------- | ------------------------------------------------ | --------------------------------------------- |
| **Definition** | Unanalyzed facts about organizational operations | Data that is relevant and useful for managers |
| **Nature**     | Raw, unprocessed                                 | Processed, meaningful                         |
| **Purpose**    | Collected and stored                             | Used for analysis and decision making         |
| **Example**    | "100 units produced"                             | "Production increased 20% this month"         |
...
| ------------------- | --------------------------------------------------------------------------- |
| **Data Capturing**  | Collecting data from various internal and external sources                  |
| **Data Processing** | Processing collected data into useful information (calculation, comparison) |
| **Prediction**      | Helping predict future situations using modern calculations and statistics  |
| **Planning**        | Helping make future plans, set targets, create goals and objectives         |
| **Controlling**     | Helping decide whether a problem exists and what action should be taken     |
...
| --------------------------- | --------------------------------------------------------------------------------------- |
| **Decision Making**         | Managers rely on information for decision making                                        |
| **Performance Measurement** | Measures performance against goals                                                      |
| **Production Management**   | Information on production costs, labor costs, need to expand plant due to higher demand |
| **Marketing Management**    | Information on sales trends, market analysis, new product development                   |
| **Personnel Management**    | Information on workforce turnover, skills and knowledge levels, wages, incentives       |
...
| Need                           | Description                                             |
| ------------------------------ | ------------------------------------------------------- |
| **Timely Information**         | Information must arrive when needed for decision making |
| **Complete Information**       | Information must be comprehensive enough                |
| **Relevant Information**       | Information must focus on what matters                  |
| **Cost-Effective Information** | Information should cost less than its worth             |
| **Clear Focus**                | Information should have clear purpose                   |
...
| Factor                                  | Description                                                   |
| --------------------------------------- | ------------------------------------------------------------- |
| **Growth of Management Theory**         | Development of management techniques and approaches           |
| **Changes in Production/Distribution**  | Evolution of production methods and organizational structures |
| **Development of Management Science**   | Application of scientific methods to management               |
| **Introduction of Computers**           | Computers in business data processing                         |
...
**Nature:** Focuses on future; more creative work; concerned with plans, policies, budgets, and objectives
...
│   Entry        Summary       Modeling      Dashboards          │
│   ↓            ↓             ↓             ↓                   │
│   Operators    Middle        Senior        Top                 │
│   Clerks       Managers      Managers      Executives          │
│   ↓            ↓             ↓             ↓                   │
